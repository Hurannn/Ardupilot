...
public:
	...
	void send_handshake(const uint8_t index);
...
private:
    ...
    uint8_t _hb_seq[2]{0,0}; // Life signal
    HBState _hb_state[2]{HBState::STANDBY, HBState::STANDBY};
	uint32_t _hb_last_rx_ms[2]{0,0};
