...
bool Mode::_TakeOff::triggered(const float target_climb_rate_ms) const
{
...
Mode::AltHoldModeState Mode::get_alt_hold_state(float target_climb_rate_cms)
{
    ...
    } else if (takeoff.running() || takeoff.triggered(target_climb_rate_cms * 0.01)) {
...
// class.
float Mode::get_pilot_desired_climb_rate_ms()
{
